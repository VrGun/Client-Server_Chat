...
public class client_frame extends javax.swing.JFrame 
{
        ...
        public void run() 
        {
            ...
            try 
            {
                while ((stream = reader.readLine()) != null) 
                {
                     ...
                     {
                    	 if(data[1].indexOf("/w") > -1){
                         	String chatResult="";
                         	String[] hasilSplit=data[1].split(" ");
                         	for (int i=2;i<hasilSplit.length;i++){
                         		chatResult+=hasilSplit[i]+" ";
                         	}
                         	ta_chat.append(data[1].split(" ")[1] +"->"+ data[0] + ": " + chatResult + "\n");
                         }
                         else 
    ...
    private void initComponents() {
        ...
        lb_name.setText("User Name Here");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(b_attach, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(b_attach, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lb_name))
                    )
        );
    ...
    private void b_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_sendActionPerformed
        ...
        if (attachment == true)
        {
        	ta_chat.append(this.username+": "+tf_chat.getText()+"\n");
        	try {
    ...
    private void b_attachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_attachActionPerformed
    	FileNameExtensionFilter filter = new FileNameExtensionFilter("txt", "mp3", "docx", "zip", "jpg", "png", "pdf", "pptx", "doc", "ppt");
    	
    	JFileChooser chooser = new JFileChooser("C:\\Users\\Samuel Teguh\\Desktop");
    	...
    	{
    		//File fileAttach = chooser.getSelectedFile();
    		//String fileAttach = file + "";
    		fileName = chooser.getSelectedFile().getName();
    		tf_chat.setText("/w " + "[username target here] " + fileName);
            attachment = true;
